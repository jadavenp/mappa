import{S as e}from"./index-B5oboHyE.js";import"./logDepthDeclaration-CXOV7on2.js";import"./helperFunctions-BrN991f9.js";import"./clipPlaneFragment-DAklacGT.js";const i="decalFragmentDeclaration",P=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=P);const t="defaultFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=x);const r="prePassDeclaration",X=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=X);const a="oitDeclaration",F=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=F);const n="lightFragmentDeclaration",R=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=R);const l="lightUboDeclaration",N=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=M);const s="lightsFragmentFunctions",O=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=O);const d="shadowsFragmentFunctions",y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const c="samplerFragmentDeclaration",b=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=b);const h="fresnelFunction",_=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=_);const v="reflectionFunction",U=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=U);const u="imageProcessingDeclaration",W=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);const p="imageProcessingFunctions",z=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=z);const m="bumpFragmentMainFunctions",H=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=H);const S="bumpFragmentFunctions",G=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=G);const g="fogFragmentDeclaration",V=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=V);const E="bumpFragment",B=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=B);const C="decalFragment",k=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=k);const D="depthPrePass",Y=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Y);const w="lightFragment",$=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=$);const I="logDepthFragment",q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);const L="fogFragment",Z=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Z);const A="oitFragment",Q=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Q);const o="defaultPixelShader",T=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=T);const oe={name:o,shader:T};export{oe as defaultPixelShader};
